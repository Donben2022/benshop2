                            ...
                            <div class="card">
                                ...
                                <table class="display" id="basic-1">
                                        ...
                                        <tbody>
                                            ...
                                            $products = "SELECT * FROM orders INNER JOIN order_details ON orders.order_id=order_details.order_details_order_id WHERE orders.order_buyer_user_id='$globalbuyerid' AND orders.status = 'paid' ";
