    ...
    <section class="bag-product pt-0 section-b-space ratio_square">
        <div class="container">
            <div class="row row-cols-xxl-6 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 gy-sm-4 gy-3 ">
                ...
                $productcheck = $_GET['searchkey'];
                $products = "SELECT * FROM `products` WHERE `product_name` LIKE '%$productcheck%'";
                    ...
                    <div class="col-lg-4 col-md-6 sub-title">
                        ...
                        <div class="footer-contant">
                            ...
                            <ul class="contact-list">
                                <li><i class="fa fa-map-marker"></i>BenShop Demo Store, Demo store India 345-659
                                </li>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i> BenShop Ecommerce website</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
