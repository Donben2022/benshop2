...
<head>
    ...
    <title>BenShop - Upload New Product</title>
                                    ...
                                    <form action="" enctype="multipart/form-data" method="POST" action="">
                                        ...
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="file" class="form-control upload_widget" id="chooseFile" placeholder="Upload Product Images" name="picture">
                                            </div>
                                            <br>
                                        </div>
                                        <div class="form-row row">
