...
<head>
    ...
    <title>BenShop - Customer Dashboard</title>
        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-sidebar">
                <div class="main-header-left d-none d-lg-block">
                    <div class="logo-wrapper"><a href="index.php"><img class="blur-up lazyloaded" src="assets/images/dashboard/BenShop-logo.png" alt=""></a></div>
                </div>
