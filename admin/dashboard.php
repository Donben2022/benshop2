                                ...
                                <div class="card-body order-datatable">
                                    <table class="display" id="basic-1">
                                        ...
                                        <tbody>
                                            ...
                                            $products = "SELECT * FROM orders INNER JOIN order_details ON orders.order_id=order_details.order_details_order_id WHERE orders.status='paid' ";
                                            ...
                                            if ($queryproductsrows >= 1) {
                                                while ($fetch = mysqli_fetch_assoc($queryproducts)) {
                                                    ...
                                                    while ($fetchcategory = mysqli_fetch_assoc($queryproduct)) {
                                                        ...
                                                        $product_user_id = $fetchcategory['product_user_id'];
                                                    }

                                                    $checkseller = "SELECT * FROM `seller` WHERE `seller_id` = '$product_user_id'";
                                                    $querycheckseller = mysqli_query($conn, $checkseller);

                                                    while ($fetchsubseller = mysqli_fetch_assoc($querycheckseller)) {
                                                        // $subcategoryname = $fetchsubcategory['sub_category_name'];
                                                        // var_dump($fetchsubseller);
                                                        $seller_mobile = $fetchsubseller['seller_mobile'];
                                                        $seller_first_name = $fetchsubseller['seller_first_name'];
                                                        $seller_last_name = $fetchsubseller['seller_last_name'];
                                                    }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href='tel:".$seller_mobile."' class='btn btn-success'>".$seller_first_name." ".$seller_last_name."</a></td>
