...
<head>
    ...
    <title>BenShop - Second Hand Products</title>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="header-contact">
                                <ul>
                                    <li>Welcome to Our store BenShop</li>
                ...
                if ($queryproductsrows >= 1) {
                    while ($fetch = mysqli_fetch_assoc($queryproducts)) {
                        ...
                        <div class='img-wrapper'>
                            <div class='front'>
                                <a href='buyer-register.php'><img alt='' src='products/$image' class='img-fluid blur-up lazyload bg-img'></a>
                            </div>
                            <div class='cart-detail'><a href='buyer-register.php' title='Add to Wishlist'><i class='ti-heart' aria-hidden='true'></i></a> <a href='buyer-register.php'  title='Quick View'><i class='ti-search' aria-hidden='true'></i></a> <a href='buyer-register.php' title='Compare'><i class='ti-reload' aria-hidden='true'></i></a></div>
                        </div>
...
<!-- https://themes.pixelstrap.com/BenShop/front-end/register.html -->